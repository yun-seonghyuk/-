...
<form method="post" name="frm" action="i_action.jsp" style="display: flex; align-items: center; justify-content: center">
	<table border="1">
		<tr>
		...
		<tr>
			...
			<td> <input id="c_no" name="c_no" readonly="readonly" style="width: 150px"> </td>
		</tr>
		<tr>
